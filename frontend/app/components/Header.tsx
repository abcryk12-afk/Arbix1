        ...
        {isMobileMenuOpen && (
          <div className="border-t border-slate-800 bg-slate-950/95 md:hidden">
            <div className="space-y-3 px-4 py-4">
              <a href="/" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">Home</a>
              <a href="/about" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">About</a>
              <a href="/how-it-works" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">How It Works</a>
              <a href="#plans" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">Profit Plan</a>
              <a href="#testimonials" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">Testimonials</a>
              <a href="/faq" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">FAQ</a>
              <a href="/contact" className="block py-2 text-sm font-medium text-slate-300 hover:text-white">Need Help?</a>
