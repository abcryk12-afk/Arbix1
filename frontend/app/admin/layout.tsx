          ...
          <div className="fixed inset-0 z-40 flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            <div className="relative flex flex-col items-center justify-center px-6">
              ...
              <div className="relative flex flex-col items-center">
                <div className="absolute -top-2 inset-x-0 mx-auto h-1 w-32 rounded-full bg-gradient-to-r from-emerald-400 via-sky-400 to-cyan-300 opacity-90 shadow-[0_0_25px_rgba(56,189,248,0.8)]" />
