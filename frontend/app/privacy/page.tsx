    ...
    <div className="bg-slate-950 text-slate-50">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">1. Information We Collect</h2>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">2. How We Use Your Information</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">3. Data Protection Measures</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">4. Cookies &amp; Tracking</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">5. Sharing of Information</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">6. User Rights</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">7. Data Retention</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          <h2 className="text-base font-semibold text-slate-50 md:text-lg">8. Third-Party Links</h2>
          <p className="mt-3 text-slate-400">
      ...
      <section className="bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <p className="mt-2 text-slate-400">privacy@arbix.com</p>
        </div>
      </section>
    </div>
  );
