      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>• Multiple accounts for the same individual are not allowed.</li>
          </ul>
        </div>
      </section>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>
              • KYC verification may be mandatory before certain features (such as
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <p className="mt-3 text-slate-400">
            ...
            while always communicating major changes to users.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>• Third-party or anonymous deposits may be rejected or reversed.</li>
            <li>
              • Deposit processing times may vary depending on network conditions
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>
              • Additional verification may be required before large or unusual
              withdrawals are approved.
            </li>
            <li>
              • Minimum withdrawal limits may apply, depending on the plan and
              currency.
            </li>
            <li>
              • Suspicious activity may result in temporary holds while a review is
              conducted.
            </li>
          </ul>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>
              ...
              activity and platform rules.
            </li>
            <li>
              • Users must follow ethical promotion practices and may not make
              misleading claims or promises to potential referrals.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-2 space-y-1 text-slate-400">
            ...
            <li>• Using bots, scripts or automation to manipulate the system.</li>
            <li>• Abusing or exploiting the referral program in any form.</li>
          </ul>
        </div>
      </section>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <ul className="mt-3 space-y-1 text-slate-400">
            ...
            <li>
              • Arbix may adjust plan structures, fees or profit models with prior
              notice when required.
            </li>
            <li>
              • Arbix may suspend or terminate accounts that violate these terms or
              are involved in suspicious or illegal activities.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="border-b border-slate-800 bg-slate-950">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-slate-300 md:text-sm">
          ...
          <p className="mt-3 text-slate-400">
            ...
            cannot be held liable for losses arising from market movements, third-
            party failures or user actions.
          </p>
        </div>
      </section>
