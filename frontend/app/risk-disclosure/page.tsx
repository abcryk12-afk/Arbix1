    ...
    <div className="bg-page text-fg">
      ...
      <section className="border-b border-border bg-page">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-muted md:text-sm">
          <h2 className="text-base font-semibold text-heading md:text-lg">1. No Guaranteed Profits</h2>
      ...
      <section className="border-b border-border bg-page">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-muted md:text-sm">
          <h2 className="text-base font-semibold text-heading md:text-lg">2. Arbitrage Trading Risk</h2>
          <p className="mt-3 text-muted">
      ...
      <section className="border-b border-border bg-page">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-muted md:text-sm">
          <h2 className="text-base font-semibold text-heading md:text-lg">3. Withdrawal &amp; Liquidity Risk</h2>
          <p className="mt-3 text-muted">
      ...
      <section className="border-b border-border bg-page">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-muted md:text-sm">
          <h2 className="text-base font-semibold text-heading md:text-lg">4. Referral / MLM Risk</h2>
          <p className="mt-3 text-muted">
      ...
      <section className="border-b border-border bg-page">
        <div className="mx-auto max-w-3xl px-4 py-8 md:py-10 text-xs text-muted md:text-sm">
          <h2 className="text-base font-semibold text-heading md:text-lg">5. Investor Responsibility</h2>
          <p className="mt-3 text-muted">
